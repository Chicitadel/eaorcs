 ...
 * File           : AirRoofersTelemetryClient.js
 * Version        : 1.0.0
...
class AirRoofersTelemetryClient {
    constructor() {
        this.gateway = new FederatedPlatformGateway('mock');
    }

    pushTelemetry(payload) {
        return this.gateway.route('telemetry', '/api/v1/telemetry', payload);
    }
}

module.exports = AirRoofersTelemetryClient;
