 ...
 * Module         : Procurement Questionnaire Generator (50 Q&A)
 * File           : ProcurementQuestionnaire.js
...
class ProcurementQuestionnaire {
  constructor(options = {}) {
  ...
  generate(outputPath) {
    const targetPath = outputPath || path.join(process.cwd(), 'docs', 'procurement', 'Procurement_Questionnaire.md');
  ...
  buildDocumentContent() {
    return `# EAORCS Enterprise Procurement Questionnaire (50 Standard Q&A)

## Overview & Scope
This formal procurement questionnaire details the technical architecture, security baseline, regulatory compliance posture, integration capabilities, and commercial commitments of the **Enterprise Autonomous Operation & Regulatory Compliance System (EAORCS ${this.version})**. 
...
- **Primary Evidence Passport**: \`${this.passportId}\`
- **Certificate Reference**: \`${this.certId}\`

---
*Document generated automatically by EAORCS Procurement Questionnaire Generator v${this.version}. Classification: RESTRICTED / GOVERNMENT / ENTERPRISE.*
`;
  }
}

module.exports = ProcurementQuestionnaire;
