 ...
 * Module         : ISO 27001 Evidence Packager
 * File           : IsoEvidencePackager.js
...
class IsoEvidencePackager {
  ...
  generate(outputPath) {
    const targetPath = outputPath || path.join(process.cwd(), 'docs', 'procurement', 'ISO_27001_Evidence_Pack.md');
  ...
  buildDocumentContent() {
    return `# ISO 27001:2022 Evidence Pack — EAORCS ${this.version}
...
- **OSAP Passport**: \`${this.passportId}\`
- **Audit Standard**: ISO/IEC 27001:2022 Annex A
- **Assessment Date**: 2026-08-01
- **Signed By**: EAORCS Certification Authority (Ed25519 Hardware Authority)

---
*Document generated automatically by EAORCS ISO Evidence Packager v${this.version}. Classification: RESTRICTED / GOVERNMENT / ENTERPRISE.*
`;
  }
}

module.exports = IsoEvidencePackager;
